...
$(wildcard $(addsuffix /Project.mk, $(addprefix $(call my-dir)/,$(1))))
endef
...
@echo ::::::::::::::::::::::::::::: transform-o-to-static-lib START ::::::::::::::::::::::::::
@mkdir -p $(dir $@)
@rm -f $@
...
@echo ::::::::::::::::::::::::::::: transform-o-to-shared-lib START ::::::::::::::::::::::::::
@mkdir -p $(dir $@)
@echo "target SharedLib: $(PRIVATE_MODULE) ($@)"
$(transform-o-to-shared-lib-inner)
@echo :::::::::::::::::::::::::::::: transform-o-to-shared-lib END :::::::::::::::::::::::::::
endef

define transform-o-to-package
@echo ::::::::::::::::::::::::::::::: transform-o-to-package START :::::::::::::::::::::::::::
@mkdir -p $(dir $@)
@echo "target Package: $(PRIVATE_MODULE) ($@)"
$(transform-o-to-shared-lib-inner)
@echo :::::::::::::::::::::::::::::::: transform-o-to-package END ::::::::::::::::::::::::::::
endef
...
$(transform-o-to-executable-inner-mod)
endef
